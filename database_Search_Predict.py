...
h=0
date_time_result=[]
goku=input('Enter Time Difference for Backward Check : ')
...
u=input('Enter Distance Range For BACKWARD Check : ')
for i in range(0,len(y)):
...
h=0
date_time_result=[]
goku=input('Enter Time Difference for Forward Check : ')
for i in range(0,len(y)):
...
u=input('Enter Distance Range for FORWARD Check : ')
for i in range(0,len(y)):
